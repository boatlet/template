...
THREE.HDRCubeTextureLoader.prototype.load = function(
  type,
  urls,
  onLoad,
  onProgress,
  ...
  texture.type = type;
  texture.encoding =
    type === THREE.UnsignedByteType ? THREE.RGBEEncoding : THREE.LinearEncoding;
  texture.format =
    type === THREE.UnsignedByteType ? THREE.RGBAFormat : THREE.RGBFormat;
  texture.minFilter =
