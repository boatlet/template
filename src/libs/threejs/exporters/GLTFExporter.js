  ...
  parse: function(input, onDone, options) {
    ...
    function processBufferView(data, componentType) {
      ...
      var gltfBufferView = {
        ...
        byteStride:
          data.itemSize *
          (componentType === WEBGL_CONSTANTS.UNSIGNED_SHORT ? 2 : 4),
        target: isVertexAttributes
    ...
    function processMaterial(material) {
      ...
      if (!(material instanceof THREE.MeshStandardMaterial)) {
        console.warn(
          'GLTFExporter: Currently just THREE.StandardMaterial is supported. Material conversion may lose information.'
        );
      }
