...
THREE.Car = function() {
  ...
  function createCar() {
    if (scope.bodyGeometry && scope.wheelGeometry) {
      ...
      scope.frontLeftWheelMesh = new THREE.Mesh(
        scope.wheelGeometry,
        wheelFaceMaterial
      );
      ...
      scope.frontRightWheelMesh = new THREE.Mesh(
        scope.wheelGeometry,
        wheelFaceMaterial
      );
      ...
      scope.backLeftWheelMesh = new THREE.Mesh(
        scope.wheelGeometry,
        wheelFaceMaterial
      );
      ...
      scope.backRightWheelMesh = new THREE.Mesh(
        scope.wheelGeometry,
        wheelFaceMaterial
      );
      ...
      scope.meshes = [
        scope.bodyMesh,
        scope.frontLeftWheelMesh,
        scope.frontRightWheelMesh,
        scope.backLeftWheelMesh,
        scope.backRightWheelMesh,
      ];
