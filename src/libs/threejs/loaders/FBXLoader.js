...
import _Zlib from '../libs/inflate.min';
import NURBSCurve from '../curves/NURBSCurve';

const Zlib = _Zlib.Zlib;
...
function parseMaterial(materialNode, textureMap, connections) {
  ...
  switch (type.toLowerCase()) {
    ...
    default:
      console.warn(
        'FBXLoader: No implementation given for material type %s in FBXLoader.js. Defaulting to basic material.',
        type
      );
...
function parseParameters(properties, textureMap, childrenRelationships) {
  ...
  for (
    ...
    switch (type) {
      ...
      default:
        console.warn(
          'FBXLoader: Unknown texture application of type %s, skipping texture.',
          type
        );
        break;
    }
